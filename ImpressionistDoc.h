...
public:
	...
	void	setStrokeDirectionType(int type);	// called by the UI to set the strokeDirection
	int		getSize();						// get the UI size
	void	setSize(int size);				// set the UI size
	int		getLineWidth();					// get the UI line width
	int		getLineAngle();					// get the UI line angle
	void	setLineAngle(int angle);		// set the UI line angle
...
public:
	...
	int					m_CurrentStrokeDirection = 0;
