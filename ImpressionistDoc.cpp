...
ImpressionistDoc::ImpressionistDoc() 
{
	...
	ImpBrush::c_pBrushes[BRUSH_CIRCULAR_SPRAY]
		= new CircularSprayBrush(this, "Circular Spray");
	ImpBrush::c_pBrushes[BRUSH_SPRAY]
		= new SprayDotBrush(this, "Spray");
...
{
	return m_pUI->setLineAngle(angle);
}
...
int ImpressionistDoc::clearCanvas() 
{
	...
	if (m_ucPreviousPainting) {
		delete [] m_ucPreviousPainting;
		m_ucPreviousPainting = NULL;
	}
...
int ImpressionistDoc::paintCanvas() {
	cout << "Paint Canvas" << endl;
	return 0;
}
...
int ImpressionistDoc::undoContent() {
	if (m_ucPreviousPainting && m_ucPainting) {
		delete [] m_ucPainting;
		m_ucPainting = m_ucPreviousPainting;
		m_ucPreviousPainting = NULL;
		m_pUI->m_paintView->refresh();
	}
	return 0;
